                ...
                {cartItems.map((food) => (
                  <div key={food.id} className="row cart-item mb-3">
                    ...
                    <div className="col-md-2 text-end">
                      <p className="fw-bold">
                        R$ {formatPriceBR(food.price * quantities[food.id])}
                      </p>
                      <button
          ...
          <div className="card cart-summary">
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between mb-3">
                <span>Subtotal</span>
                <span>R$ {formatPriceBR(subtotal)}</span>
              </div>
              <div className="d-flex justify-content-between mb-3">
                <span>Shipping</span>
                <span>R$ {formatPriceBR(subtotal === 0 ? 0 : shipping)}</span>
              </div>
              <div className="d-flex justify-content-between mb-3">
                <span>Tax</span>
                <span>R$ {formatPriceBR(tax)}</span>
              </div>
              <hr />
              <div className="d-flex justify-content-between mb-4">
                <strong>Total</strong>
                <strong>R$ {formatPriceBR(subtotal === 0 ? 0 : total)}</strong>
              </div>
              <button
